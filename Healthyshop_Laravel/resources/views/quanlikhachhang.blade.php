...
<head>
	...
	<title>Healthy shop- Quản lí khách hàng </title>
    	 ...
    	 <table class="table table-list-search">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$t->id}}</td>
                            <td>
                                <a href="suakh/{{$t->id}}">{{$t->hoten}}</a>
                            </td>
                            <td>{{$t->diachi}}</td>
                            <td>{{$t->sdt}}</td>
							<td><a href="{{Route('suakh',$t->id)}}"><button class="btn btn-success">Sửa</button></td>
							<td><a href="{{Route('xoakh',$t->id)}}"><button class="btn btn-success">Xóa</button></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>   
