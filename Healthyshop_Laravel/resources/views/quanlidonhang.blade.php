...
<head>
	...
	<title>Healthy shop- Quản lí đơn hàng </title>
    	 ...
    	 <table class="table table-list-search">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @foreach($tenkh as $t)
                                    @if($t->id==$sp->id_customer)
                                        <a href="chitiet/{{$sp->id}}">{{$t->hoten}}</a>
                                    @endif
                                @endforeach
                            </td>
                            <td>
							...
							@else
							<td><a href="{{Route('xacnhandonhang',$sp->id)}}"><button class="btn btn-success">Xác nhận đơn</button></td>
                            @endif
							<td><a href="{{Route('xoadonhang',$sp->id)}}"><button class="btn btn-success">Xóa</button></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>   
